...
def create_intro_tab():
    ...
    html.Div(children = [
             ...
             style = {})
                        ...
                        # html.Div(children = [
                        #             html.Div(project_blurb, style = {'width': '48vw','display':'inline-block','margin-right': '1vw'}),
                        #             html.Div(data_blurb, style = {'vertical-align': 'top','width' : '48vw','display':'inline-block'})
                        #     ],
                        #         style = {})
